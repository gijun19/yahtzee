    ...
    scorecard: [
      {
        id: 'ones',
        name: 'Ones',
        description: 'Get as many ones as possible. ' + 'Scores the sum of dice with the number 1.',
        points: null,
        locked: false,
        type: 'score',
      },
      {
        id: 'twos',
        name: 'Twos',
        description: 'Get as many twos as possible. ' + 'Scores the sum of dice with the number 2.',
        points: null,
        locked: false,
        type: 'score',
      },
      {
        id: 'threes',
        name: 'Threes',
        description: 'Get as many threes as possible. ' + 'Scores the sum of dice with the number 3.',
        points: null,
        locked: false,
        type: 'score',
      },
      {
        id: 'fours',
        name: 'Fours',
        description: 'Get as many fours as possible. ' + 'Scores the sum of dice with the number 4.',
        points: null,
        locked: false,
        type: 'score',
      },
      {
        id: 'fives',
        name: 'Fives',
        description: 'Get as many fives as possible. ' + 'Scores the sum of dice with the number 5.',
        points: null,
        locked: false,
        type: 'score',
      },
      {
        id: 'sixes',
        name: 'Sixes',
        description: 'Get as many sixes as possible. ' + 'Scores the sum of dice with the number 6.',
        points: null,
        locked: false,
        type: 'score',
      },
      ...
      },
      {
        ...
        name: 'Bonus',
        description:
          'If the sum of all the single number combinations is 63 or more, ' + 'scores a bonus of 35 points.',
        points: null,
        type: 'summary',
      },
      {
        ...
        description:
          'Get three dice with the same number. ' + 'Scores the sum of all dice (not just the three of a kind).',
        points: null,
        locked: false,
        type: 'score',
      },
      {
        ...
        name: 'Four of a kind',
        description:
          'Get four dice with the same number. ' + 'Scores the sum of all dice (not just the four of a kind).',
        points: null,
        locked: false,
        type: 'score',
      },
      {
        id: 'full-house',
        name: 'Full house',
        description: 'Get three of a kind and a pair, e.g. 1,1,3,3,3 or 3,3,3,6,6. ' + 'Scores 25 points.',
        points: null,
        locked: false,
        type: 'score',
      },
      {
        id: 'small-straight',
        name: 'Small straight',
        description: 'Get four sequential dice, 1,2,3,4 or 2,3,4,5 or 3,4,5,6. ' + 'Scores 30 points.',
        points: null,
        locked: false,
        type: 'score',
      },
...
Games.prototype.select = function(game, id) {
  return bluebird.bind(this).then(function() {
    ...
    if (!item || item.type !== 'score' || item.locked) {
      return utils.error(422, 'Invalid attempt to select an invalid score item');
    }
